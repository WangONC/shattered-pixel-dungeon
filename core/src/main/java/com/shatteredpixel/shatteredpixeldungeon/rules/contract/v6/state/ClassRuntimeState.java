...
public final class ClassRuntimeState {
	private final StableId buildId;private final List<ResourceState> resources;private final List<ModeState> modes;
	...
	private ClassRuntimeState(Builder value){if(value.buildId==null)throw new IllegalArgumentException("runtime build id is required");
		buildId=value.buildId;resources=copy(value.resources);modes=copy(value.modes);marks=copy(value.marks);entities=copy(value.entities);
	...
	public StableId buildId(){return buildId;}public List<ResourceState> resources(){return resources;}public List<ModeState> modes(){return modes;}
	...
	public static final class Builder{
		private StableId buildId;private List<ResourceState> resources=new ArrayList<>();private List<ModeState> modes=new ArrayList<>();private List<MarkState> marks=new ArrayList<>();
