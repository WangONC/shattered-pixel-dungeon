...
public final class BuilderCommandTrace {
	...
	private static BuilderCommand parse(String type, String[] a) {
		switch (type) {
			...
			case "SelectTriggerVariant": count(type,a,2);return new BuilderCommand.SelectTriggerVariant(a[0],a[1]);
			case "SelectConditionVariant": count(type,a,2);return new BuilderCommand.SelectConditionVariant(a[0],a[1]);
			case "SelectEffectFamily": count(type,a,3);return new BuilderCommand.SelectEffectFamily(a[0],a[1],a[2]);
			case "SelectEffectVariant": count(type,a,3);return new BuilderCommand.SelectEffectVariant(a[0],a[1],a[2]);
			case "SetTargetingSelector": count(type,a,2);return new BuilderCommand.SetTargetingSelector(a[0],a[1]);
			case "SetTargetingCoverage": count(type,a,2);return new BuilderCommand.SetTargetingCoverage(a[0],a[1]);
			case "SetTargetingFilter": count(type,a,2);return new BuilderCommand.SetTargetingFilter(a[0],a[1]);
			case "SetDelivery": count(type,a,2);return new BuilderCommand.SetDelivery(a[0],a[1]);
			case "SetModifier": count(type,a,2);return new BuilderCommand.SetModifier(a[0],a[1]);
			case "SetCost": count(type,a,2);return new BuilderCommand.SetCost(a[0],a[1]);
			case "SetSkillConstraint": count(type,a,2);return new BuilderCommand.SetSkillConstraint(a[0],a[1]);
			case "SetTypedSkillField": count(type,a,5);return new BuilderCommand.SetTypedSkillField(a[0],a[1],a[2],a[3],a[4]);
			case "SetTypedSkillReference": count(type,a,7);return new BuilderCommand.SetTypedSkillReference(a[0],a[1],a[2],a[3],ref(a,4));
