...
$checkpointPath = Join-Path $checkpointRoot 'SPD_GC_V6_P03_TYPED_SKILL_CHECKPOINT.zip'
...
@(
    '# P03 Checkpoint 解压副本复验报告'
    ''
    "- Status: $status"
    '- Checkpoint: SPD_GC_V6_P03_TYPED_SKILL_CHECKPOINT.zip'
