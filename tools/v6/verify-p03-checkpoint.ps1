...
$checkpointPath = Join-Path $checkpointRoot 'SPD_GC_V6_P03_R2_RUNTIME_CHECKPOINT.zip'
...
@(
    '# P03-R2 Checkpoint 解压副本复验报告'
    ''
    "- Status: $status"
    '- Checkpoint: SPD_GC_V6_P03_R2_RUNTIME_CHECKPOINT.zip'
